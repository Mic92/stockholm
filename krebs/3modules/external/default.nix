    ...
    crustacea = {
      ...
      nets = {
        retiolum = {
          ...
          tinc.pubkey = ''
            -----BEGIN RSA PUBLIC KEY-----
            
            -----END RSA PUBLIC KEY-----
          '';
        };
      };
