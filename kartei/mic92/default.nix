...
in {
  hosts = mapAttrs hostDefaults {
    ...
    ruby = {
      ...
      nets = rec {
        ...
        retiolum = {
          ...
          tinc.pubkey = ''
            -----BEGIN RSA PUBLIC KEY-----
            
            -----END RSA PUBLIC KEY-----
          '';
    ...
    dorits-laptop = {
      ...
      nets = {
        retiolum = {
          aliases = [ "dorits-laptop.r" ];
          tinc.pubkey = ''
            -----BEGIN RSA PUBLIC KEY-----
            
            -----END RSA PUBLIC KEY-----
          '';
          tinc.pubkey_ed25519 = "92sT36/swarqarNnbHc4xqm8Ipkd8UZGdgOfFIJZfVP";
        };
      };
    };
  };
